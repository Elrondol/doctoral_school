...
#####  GRID OF SOURCES ##### 
x = np.linspace(-74,-69, 3)
y = np.linspace(-38, -31, 3)
...
nl = 10 #None   ####None or integer   if None, computes for all windows 


###### cross correlation parameters ####
cross_duration = 4 #duraction of the cross correlation 
